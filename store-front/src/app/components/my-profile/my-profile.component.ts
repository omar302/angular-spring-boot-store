...
export class MyProfileComponent implements OnInit {
  ...
  onUpdateUserInfo () {
  	// grey ot submit button if currentPassword is null (it is required for any update)
  	// should confirm newPassword and confirmPassword match also
  ...
  ngOnInit() {
    ...
    for (let s in AppConst.auStates) {
